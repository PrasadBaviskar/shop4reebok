...
function showCatlogues(){
     ...
     catlog_price.textContent= "Price: "+ x.selling_price;
    ...
    fav_btn.innerText="♡"+" "+ " ";
      ...
      div1.append(catlog_name,color,size,catlog_price,catlog_price1,img1,addtocart_btn,fav_btn);
